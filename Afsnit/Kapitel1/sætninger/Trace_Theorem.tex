\begin{thmx}{Trace Theorem}~\label{thm:trace}
    Let $\Omega$ be a bounded, and suppose $\Omega$ has a piecewise smooth boundary. In addition, suppose $\Omega$ satisfies the cone condition. Then there exists a bounded linear mapping %TODO Spørg Anton skal det være Omega eller en anden version af det 
    \begin{equation*}
...
\begin{bev}
    ...
    \begin{enumerate}
        ...
        \item The domain $\Omega_i = \{ (x,y) \subset \RR^2 \quad | \quad \phi(y) < x <\phi(y) + r, y_1 < y < y_n \}$ is contained in $\Omega$, where $r > 0$. %TODO Spørg Anton om det skal omskrives, eller måske uddybes at det skal være et passende r > 0
    \end{enumerate}
    ...
    \end{equation} %TODO Spørg Anton i forhold til hvor brøken forsvinder hen
