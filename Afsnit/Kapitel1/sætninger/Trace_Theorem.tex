...
\begin{defn}{Trace Theorem}~\label{defn:trace}
    Let $\Omega$ be a bounded, and suppose $\Omega$ has a piecewise smooth boundary. In addition, suppose $\Omega$ satisfies Defintion~\ref{def:cone_condition}. Then there exists a bounded linear mapping %! Var lille omega før? Er det her nok?
    \begin{equation*}
