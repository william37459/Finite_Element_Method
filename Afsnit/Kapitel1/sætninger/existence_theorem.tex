...
\begin{bev}
    ...
    \]
    Further more the the uniform ellipticity implies the pointwise estimate %TODO Hvorfor gør den det?
    \[
        \sum_{i,k} a_{ik} \partial_i v \partial_k v \geq \alpha \sum_i {\left( \partial_i v \right)}^2,
    \]

    For $\text{C}^1$ functions. Integrating both sides and using $\text{a}_0 \leq 0$ leads to %TODO Er det fordi man fjerner noget i integralet?
    \begin{equation}
