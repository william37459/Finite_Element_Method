...
%! Anton ellipticitet rettelser mht a
...
%! Efterfølgende tekst mht variational problem skal flytttes op til lige før sætning 1.9
...
\begin{defn}{\quad}
    ...
    \eqref{eq:b_v_problem_homogeneous}, has a weak solution $u\in H_0^1(\OO)$
     if 
     \begin{equation*}
...
%! Sætning 1.9 til sætning 1.13 skal fortællingen tydeliggøres - hvad gør hvad sætning for os (i ord), og hvorfor gør vi det
...
%! Skridtet fra svage løsninger til at overgå til Neumann
