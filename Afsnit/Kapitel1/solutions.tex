...
the space in which we work. To do this, we work with Hilbert spaces. %TODO Omskriv, Hilbert rum er bare komplet
...
%TODO Sætning 1.9 til sætning 1.13 skal fortællingen tydeliggøres - hvad gør hvad sætning for os (i ord), og hvorfor gør vi det
