...
zero on the boundary are at least an $L_2$ function, and as such are bounded. %FIXME Kig efter Anton rettelser
\subsection{Attributes of Solutions}
By rephrasing the problems to the form shown in the 
following theorem,
the equality in the theorem can be used to find solutions. %FIXME Kig igen, når Antons svar er rettet
...
%FIXME Skridtet fra svage løsninger til at overgå til Neumann
