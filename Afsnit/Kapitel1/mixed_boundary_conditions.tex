...
In a room with two open windows, and a vacuum cleaner placed in the middle of the room aimed at a fixed point. The wind flowing through the windows can be described using a Neumann boundary condition, while the flow around the vacuum cleaner would result in a Dirichlet boundary condition.
\end{exmp}
