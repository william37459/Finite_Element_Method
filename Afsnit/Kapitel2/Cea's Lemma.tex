...
\begin{proof}
    ...
    \begin{align}
    \begin{split}
        a(u,v)&=\langle \ell ,v\rangle \quad \forall v\in V,\\
        a(u_h,v)&=\langle \ell ,v_h\rangle \quad \forall v\in S_h.
    \end{split}
    \end{align}
    ...
    \end{equation}
    Now let $v_h\in S_h$ and $v=v_h-u_h$. Then combining this with \ref{eq:cea_proof}, we get  
    \begin{equation}
