...
%The terminology in the literature is as follows: 
An \emph{element} or \emph{cell} is a 
subset of $\OO$, meaning a geometric object, and a \emph{finite element} is a 
a triple, containing a space, functionspace, and a set of linear 
functionals which can used to determine all functions in the functionspace.
