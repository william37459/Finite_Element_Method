In cases where a transformation might not be desired, a triangulation might be preffered.
...
\begin{bev}
    ...
    Thus we get that *ref* $||B|| \leq h/\hat{\rho}\leq 4h$. %TODO Informationen omkring ligning (6.9) skal tilføjes
