Previously we introduced different bounds to specific problems and we now expand on these to obtain a stronger error bounds for the finite element approximation. 
