Previously we introduced different boundaries to specific problems and we now expand on these to obtain a stronger error boundary for the finite element approximation. 
